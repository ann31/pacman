...
#power pellet special animations
pghost = pygame.image.load('PPghost.png')
ppellet =  pygame.image.load('powerPellet.png')
...
chompSound = pygame.mixer.Sound('pacman_chomp.wav')
bg_music = pygame.mixer.music.load('siren_1.wav')
...
pac_grid = [['b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b'],
            ['b','p','p','p','p','p','p','p','p','p','p','p','p','b','b','p','p','p','p','p','p','p','p','p','p','p','s','b'],
            ...
            ['b','p','b','b','b','b','p','b','b','b','b','b','p','b','b','p','b','b','b','b','b','p','b','b','b','b','p','b'],
            ['b','p','b','b','b','b','p','b','b','b','b','b','p','b','b','p','b','b','b','b','b','p','b','b','b','b','p','b'],
            ['b','p','p','p','b','b','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','b','b','p','s','p','b'],
    ...
    for i in range(31):
        for j in range (28):
            if pac_grid[i][j]=='b':
                ...
                win.blit(ppellet,(j*cell_w,i*cell_h))
...
class player:
    ...
    def check(self,c,s):
        global pelCount, super_mode, scoreCount
        ...
        elif pac_grid[self.j][self.i]=='s':
            pac_grid[self.j][self.i] = 'n'
            inky.super_mode = True
            pinky.super_mode = True
            blinky.super_mode = True
            clyde.super_mode = True
            return 1
